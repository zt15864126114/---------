...
const VisitorRecords: React.FC = () => {
  ...
  const [recordData] = useState<VisitorRecordData[]>([
    ...
    },
    {
      ...
      description: '设备定期维护',
      createTime: '2025-03-19 15:30:00',
      updateTime: '2025-03-20 16:00:00',
    },
    {
      id: '3',
      visitorName: '赵琳',
      ...
      host: '周八',
      department: '市场部',
      visitTime: '2025-03-21 09:30:00',
      leaveTime: '2025-03-21 17:30:00',
      status: 'scheduled',
      vehicleNumber: '京C12345',
      description: '项目现场考察',
      createTime: '2025-03-19 16:30:00',
      updateTime: '2025-03-19 16:30:00',
    },
  ]);
