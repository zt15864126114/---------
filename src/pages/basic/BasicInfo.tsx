...
const BasicInfo: React.FC = () => {
  ...
  const [parkData] = useState<ParkData[]>([
    ...
    },
    {
      ...
      maintainer: '李华',
      description: '济南科技创新园是重点打造的科技创新示范基地，占地面积30万平方米，总投资20亿元。园区聚焦生物医药、新材料、智能制造等领域，已入驻企业30余家，年产值超过50亿元。',
      createTime: '2024-01-01',
    ...
    },
    {
      ...
      maintainer: '王强',
      description: '青岛智慧产业园是集智能制造、研发创新、商务办公于一体的综合性产业园区，占地面积80万平方米，总投资50亿元。园区重点发展高端装备制造、新能源、海洋科技等产业，已入驻企业80余家，年产值超过200亿元。',
      createTime: '2024-01-01',
